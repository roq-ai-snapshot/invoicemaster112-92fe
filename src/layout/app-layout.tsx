...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'contract', path: '/contracts', entity: 'contract', service: AccessServiceEnum.PROJECT, icon: FiHome },
  {
  ...
  { name: 'invoice', path: '/invoices', entity: 'invoice', service: AccessServiceEnum.PROJECT, icon: FiHome },
  {
    name: 'organisation',
    path: '/organisations',
    entity: 'organisation',
  ...
  { name: 'payment', path: '/payments', entity: 'payment', service: AccessServiceEnum.PROJECT, icon: FiHome },
